...
def test_amphipathic_index_0(sequence0, mocker):
    ...
    assert resume[0] == [
        ...
        {
            'amphipathic': {
                'index': 1.6242872515167734,
                'mean': 0.9799999999999998,
            },
            'begin': 3,
            'end': 5,
            'seq': 'iq',
...
def test_amphipathic_index_2(sequence2, mocker):
    ...
    assert resume[0] == [
        ...
        },
        {
            ...
            'seq': 'tvelkcqvl',
            'amphipathic': {
                'index': 0.9132957541599984,
                'mean': 1.6855555555555555,
            },
        },
        {
            'type': 'c',
            ...
            'end': 54,
            'seq': 'lsnptsgc',
            'amphipathic': {'index': 1.0, 'mean': 0.53},
        },
        {
            'type': 'e',
            'begin': 54,
            ...
            'seq': 'swlf',
            'amphipathic': {
                'index': 0.6423054796591475,
                'mean': 2.6725000000000003,
            },
        },
        {
            'type': 'c',
...
def test_amphipathic_index_3(sequence3, mocker):
    ...
    seq = [
        [s for s in prot if s['amphipathic']['index'] > 2.5] for prot in resume
    ]
    print('---')
