...
EXPECTED_PROPERTIES_VALUES = [
    (cornette.is_experimental, True, 'prift', False),
    (cornette.is_experimental, False, 'prift', False),
    (cornette.is_owned, True, 'prift', True),
    (cornette.is_average, True, 'prift', False),
    (cornette.is_statistical, True, 'prift', True),
    (cornette.is_statistical, True, 'ponnu', True),
]


@pytest.mark.parametrize(
    'property,normalized,scale,expected', EXPECTED_PROPERTIES_VALUES
)
